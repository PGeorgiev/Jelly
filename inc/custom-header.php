 ...
 * @uses jelly_header_style() to style front-end.
 * @uses jelly_admin_header_style() to style wp-admin form.
...
function jelly_custom_header_setup() {
	$args = array(
		...
		'default-image'          => '%s/images/headers/circle.jpg',
	...
	register_default_headers( array(
		'circle' => array(
			'url'           => '%s/images/headers/circle.jpg',
			'thumbnail_url' => '%s/images/headers/circle-thumbnail.jpg',
...
function jelly_custom_header_fonts() {
	...
	wp_enqueue_style( 'jelly-fonts', jelly_fonts_url(), array(), null );

	// Add Genericons font.
	wp_enqueue_style( 'genericons', get_template_directory_uri() . '/genericons/genericons.css', array(), '3.03' );
}
add_action( 'admin_print_styles-appearance_page_custom-header', 'jelly_custom_header_fonts' );
...
function jelly_admin_header_style() {
	$header_image = get_header_image();
?>
	<style type="text/css" id="jelly-admin-header-css">
